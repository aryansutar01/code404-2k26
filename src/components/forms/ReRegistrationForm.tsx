...
import { saveReRegistration } from "@/services/registrationService";
...
export function ReRegistrationForm() {
    ...
    const WHATSAPP_LINKS = {
        "Avatar: The Algo War": "https://chat.whatsapp.com/HfND48GrOqnCYC0IauZbcG",
        "Neural Link": "https://chat.whatsapp.com/DrLrY5cRFHOLkD3e6yNsUa",
        "The Voice of Eywa": "https://chat.whatsapp.com/F6QjSwv0N1V7FI0THRoOUS"
    };
    ...
    const eventOptions = [
        { value: "Avatar: The Algo War", label: "Avatar: The Algo War" },
        { value: "Neural Link", label: "Neural Link" },
        { value: "The Voice of Eywa", label: "The Voice of Eywa" },
    ];
    ...
    async function onSubmit(data: any) {
        ...
        try {
            ...
            setTimeout(() => {
                const link = WHATSAPP_LINKS[data.eventName as keyof typeof WHATSAPP_LINKS];
        ...
        <div className="glass-card p-6 md:p-8 rounded-3xl border border-white/10 relative">
            ...
            <div className="mb-6">
                ...
                <p className="text-soft-white/60 text-sm md:text-base">
                    Fill in your details to secure your spot (No Payment Required)
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="pt-2">
                    <Button
                        ...
                        className="w-full h-12 md:h-14 text-base md:text-lg bg-bio-green text-midnight-blue hover:bg-bio-green/90"
                    >
